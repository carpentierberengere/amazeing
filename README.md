...
We were asked to create a functionning maze using JavaScript, a HTML squeletton file and some CSS. 

## What did we do ? 

We created a new repository, with an HTML file (*index.html*), a JS file (*maze.js*), and a CSS stylesheet (*maze.css*). 
